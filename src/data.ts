...
export const teams: Team[] = [
  ...
  { code: "TUR", name: "Turquía", totalStickers: 20 },
  ...
  { code: "SWE", name: "Suecia", totalStickers: 20 },
  ...
  { code: "IRQ", name: "Irak", totalStickers: 20 },
  ...
  { code: "COD", name: "RD Congo", totalStickers: 20 },
